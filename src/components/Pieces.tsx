...
const PATHS: Record<string, string> = {
  ...
  // Queen (Cburnett — 5 symmetric spikes with jewels)
  wq: make(`
    <g fill="${fill("w")}" stroke="${stroke("w")}" stroke-width="1.5" stroke-linejoin="round">
  ...
  // Knight (Cburnett — full head silhouette with ear and snout)
  wn: make(`
    <g fill="${fill("w")}" stroke="${stroke("w")}" stroke-width="1.5" stroke-linejoin="round">
      <path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18" stroke-linecap="butt"/>
      <path d="M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,5.5 16.5,4.5 16.5,4.5 L 18,5 L 16,2 L 19,2 L 18,4 L 20,3.5 L 19.5,5.5 C 19.5,5.5 21.5,5 21.5,6" stroke-linecap="butt"/>
